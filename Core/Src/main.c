...
void SystemClock_Config(void)
{
  ...
  * HSE = 8MHz, PLL: 8MHz/8=1MHz, 1MHz*336=336MHz, 336MHz/2=168MHz
  */
  ...
  * SYSCLK=168MHz, HCLK=168MHz, APB1=42MHz, APB2=84MHz
  */
...
/**
  ...
  * @retval None
  */
/* HAL_TIM_PeriodElapsedCallback 已移至 bsp_sys_timer.c 统一管理 */
